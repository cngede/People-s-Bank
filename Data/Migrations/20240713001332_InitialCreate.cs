    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LoginId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    CustomerId = table.Column<int>(type: "INTEGER", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StatemomentumId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    CustomerId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Statemomentum", x => x.StatemomentumId);
                    table.ForeignKey(
                        name: "FK_Statemomentum_Statement_StatementId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Statemomentum_StatementId",
                table: "Statemomentum",
                column: "StatementId");
        }
